...
class GTExPortalAPIInfoApi:
    ...
    @validate_call
    def get_service_info_api_v2_get(
        self,
        ...
        _param = self._get_service_info_api_v2_get_serialize(
    ...
    @validate_call
    def get_service_info_api_v2_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_service_info_api_v2_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_service_info_api_v2_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
