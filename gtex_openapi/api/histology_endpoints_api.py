...
class HistologyEndpointsApi:
    ...
    @validate_call
    def get_image_api_v2_histology_image_get(
        self,
        tissue_sample_id: Annotated[Optional[List[StrictStr]], Field(description="A list of Tissue Sample ID(s)")] = None,
        ...
        _param = self._get_image_api_v2_histology_image_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResponseHistologySample",
    ...
    @validate_call
    def get_image_api_v2_histology_image_get_with_http_info(
        self,
        tissue_sample_id: Annotated[Optional[List[StrictStr]], Field(description="A list of Tissue Sample ID(s)")] = None,
        page: Annotated[Optional[Annotated[int, Field(le=1000000, strict=True, ge=0)]], Field(description="The 0-based numeric ID of the page to retrieve")] = None,
        items_per_page: Optional[Annotated[int, Field(le=100000, strict=True, ge=1)]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResponseHistologySample]:
        """Get Image
    ...
    @validate_call
    def get_image_api_v2_histology_image_get_without_preload_content(
        self,
        tissue_sample_id: Annotated[Optional[List[StrictStr]], Field(description="A list of Tissue Sample ID(s)")] = None,
        page: Annotated[Optional[Annotated[int, Field(le=1000000, strict=True, ge=0)]], Field(description="The 0-based numeric ID of the page to retrieve")] = None,
        items_per_page: Optional[Annotated[int, Field(le=100000, strict=True, ge=1)]] = None,
    ...
    def _get_image_api_v2_histology_image_get_serialize(
        self,
        tissue_sample_id,
        page,
        items_per_page,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/histology/image',
