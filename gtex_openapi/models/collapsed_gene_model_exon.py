...
class CollapsedGeneModelExon(BaseModel):
    """
    ...
    strand: Strand
    __properties: ClassVar[List[str]] = ["featureType", "end", "genomeBuild", "chromosome", "exonNumber", "geneSymbolUpper", "exonId", "datasetId", "start", "dataSource", "gencodeId", "geneSymbol", "gencodeVersion", "strand"]
