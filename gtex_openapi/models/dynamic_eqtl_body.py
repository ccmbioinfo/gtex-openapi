...
class DynamicEqtlBody(BaseModel):
    """
    DynamicEqtlBody
    """ # noqa: E501
    variant_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="variantId")
    gencode_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="gencodeId")
    tissue_site_detail_id: TissueSiteDetailId = Field(alias="tissueSiteDetailId")
    __properties: ClassVar[List[str]] = ["variantId", "gencodeId", "tissueSiteDetailId"]
