...
class ExpressionPCA(BaseModel):
    """
    ExpressionPCA
    """ # noqa: E501
    pc1: Union[StrictFloat, StrictInt]
    pc2: Union[StrictFloat, StrictInt]
    pc3: Union[StrictFloat, StrictInt]
    ...
    __properties: ClassVar[List[str]] = ["pc1", "pc2", "pc3", "sampleId", "tissueSiteDetailId", "ontologyId", "datasetId"]
