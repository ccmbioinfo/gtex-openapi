...
class FineMapping(BaseModel):
    ...
    method: StrictStr
    pip: Union[StrictFloat, StrictInt]
    set_id: StrictInt = Field(alias="setId")
    set_size: StrictInt = Field(alias="setSize")
    ...
    __properties: ClassVar[List[str]] = ["datasetId", "gencodeId", "method", "pip", "setId", "setSize", "tissueSiteDetailId", "ontologyId", "variantId"]
