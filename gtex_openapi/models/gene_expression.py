...
class GeneExpression(BaseModel):
    ...
    unit: Units
    subset_group: Optional[Subsetgroup] = Field(default=None, alias="subsetGroup")
    __properties: ClassVar[List[str]] = ["data", "tissueSiteDetailId", "ontologyId", "datasetId", "gencodeId", "geneSymbol", "unit", "subsetGroup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of subset_group
        if self.subset_group:
            _dict['subsetGroup'] = self.subset_group.to_dict()
        # set to None if subset_group (nullable) is None
        # and model_fields_set contains the field
        if self.subset_group is None and "subset_group" in self.model_fields_set:
            _dict['subsetGroup'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "subsetGroup": Subsetgroup.from_dict(obj["subsetGroup"]) if obj.get("subsetGroup") is not None else None
        })
        return _obj
