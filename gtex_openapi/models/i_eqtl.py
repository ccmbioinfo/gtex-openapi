...
class IEqtl(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cellType", "data", "datasetId", "enrichmentScores", "gencodeId", "genotypes", "regressionCoord", "tissueSiteDetailId", "variantId"]
