...
class IndependentEqtl(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gencodeId", "geneSymbol", "variantId", "snpId", "tissueSiteDetailId", "ontologyId", "rank", "tssDistance", "maf", "pValue", "nes", "chromosome", "pos", "datasetId"]
