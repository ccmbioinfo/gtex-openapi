...
class MedianTranscriptExpression(BaseModel):
    """
    ...
    unit: Units
    __properties: ClassVar[List[str]] = ["median", "transcriptId", "tissueSiteDetailId", "ontologyId", "datasetId", "gencodeId", "geneSymbol", "unit"]
