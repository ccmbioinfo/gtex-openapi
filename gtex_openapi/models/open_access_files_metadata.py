...
class OpenAccessFilesMetadata(BaseModel):
    """
    Project Level Open Access Files Metadata
    """ # noqa: E501
    data: List[OpenAccessFolder]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OpenAccessFolder.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
