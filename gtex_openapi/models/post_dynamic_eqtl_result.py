...
class PostDynamicEqtlResult(BaseModel):
    """
    PostDynamicEqtlResult
    """ # noqa: E501
    data: List[PostEqtl]
    errors: List[PostEqtlError]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PostEqtl.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "errors": [PostEqtlError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
