...
class SGene(BaseModel):
    ...
    SGene
    """ # noqa: E501
    n_phenotypes: StrictInt = Field(alias="nPhenotypes")
    ...
    __properties: ClassVar[List[str]] = ["nPhenotypes", "pValueThreshold", "phenotypeId", "geneSymbol", "pValue", "datasetId", "empiricalPValue", "tissueSiteDetailId", "ontologyId", "qValue", "gencodeId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nPhenotypes": obj.get("nPhenotypes"),
