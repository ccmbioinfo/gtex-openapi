...
class Sqtl(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "error", "genotypes", "hetCount", "homoAltCount", "homoRefCount", "maf", "nes", "pValue", "pValueThreshold", "phenotypeId", "tStatistic", "tissueSiteDetailId", "variantId"]
