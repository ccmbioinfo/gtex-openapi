...
class TestPaginatedResponseFunctionalAnnotation(unittest.TestCase):
    """PaginatedResponseFunctionalAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResponseFunctionalAnnotation:
        """Test PaginatedResponseFunctionalAnnotation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResponseFunctionalAnnotation`
        """
        model = PaginatedResponseFunctionalAnnotation()
        if include_optional:
            return PaginatedResponseFunctionalAnnotation(
                data = [
                    gtex_openapi.models.functional_annotation.FunctionalAnnotation(
                        variant_id = '', 
                        enhancer = True, 
                        promoter = True, 
    ...
    def testPaginatedResponseFunctionalAnnotation(self):
        """Test PaginatedResponseFunctionalAnnotation"""
