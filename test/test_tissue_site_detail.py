...
class TestTissueSiteDetail(unittest.TestCase):
    """TissueSiteDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TissueSiteDetail:
        """Test TissueSiteDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TissueSiteDetail`
        """
        model = TissueSiteDetail()
        if include_optional:
            return TissueSiteDetail(
